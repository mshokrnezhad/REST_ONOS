    ...
    def get_all_devices(self):
        ...
        if self.is_successful(response[0], "Get Info") == True:
            ...
            for d in temp['devices']:
               ...
               device_obj = device(device_index, re.sub("of:000000000000000" ,"SW_" , d['id']), d['annotations']['name'], d['hw'], [])
        ...
        if self.is_successful(response[0], "Get Info") == True:
            ...
            for l in temp['links']:
               for device_obj in devices:
               	if re.sub("of:000000000000000" ,"SW_" , device_obj.get_id()) == re.sub("of:000000000000000" ,"SW_" , str(l['src']['device'])):
    ...
    def get_all_hosts(self):
        ...
        if self.is_successful(response[0], "Get Info") == True:
            ...
            for h in temp['hosts']:
               ...
               host_obj = host(host_index, re.sub("00:00:00:00:00:", "H_", re.sub("/None", "", h['id'])), re.sub("[][']", '', str(h['ipAddresses'])), [])
